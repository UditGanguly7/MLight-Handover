...
for snr_idx = 1:num_snr
    ...
    success_3gpp(snr_idx) = success_prob * 100;
...
for snr_idx = 1:num_snr
    ...
    success_basic_ml(snr_idx) = success_prob * 100;
    fprintf('  SNR %d dB: %.1f%%\n', SNR, success_basic_ml(snr_idx));
end

%% MLight-Handover (Your method)
...
% FIXED: No sgtitle - just a simple figure title
% title('MLight-Handover: Baseline Comparison', 'FontSize', 14);
