%% STEP 2: MLight-Handover - PRACH Correlator (OCTAVE COMPATIBLE)
pkg load signal;
...
differential_delay = (tau - tau_prev) * 1e6;
...
fprintf('\n--- DQN Feature Vector (8 dimensions) ---\n');
...
for i = 1:num_visible
    ...
    true_doppler_profile(i) = f_true / 1000;
end
...
%% Plot (OCTAVE COMPATIBLE - no sgtitle, no yyaxis, hist instead of histogram)
